...
/* A BPF_PROG_TYPE_CGROUP_SOCK context is the struct sock itself.  Unlike
 * helpers used by skb/sock_addr programs, arg2 therefore arrives as the BPF
 * context rather than a PTR_TO_BTF_ID socket.  This is the dedicated proto
 * used by Linux 5.10 for sk_storage_get from cgroup/sock programs.
 */
